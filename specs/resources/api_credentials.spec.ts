...
describe('ApiCredentials resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const intId = clp.addRequestInterceptor((config) => {
      ...
      expect(clp[resourceType].isApiCredential(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(clp[resourceType].isApiCredential(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = clp[resourceType].parse(payload) as ApiCredential
