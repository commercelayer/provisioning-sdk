...
const OPEN_API_SCHEMA_VERSION = '1.0.15'
...
class CommerceLayerProvisioningClient {
	...
	get identity_providers(): api.IdentityProviders { return this.#identity_providers || (this.#identity_providers = new api.IdentityProviders(this.#adapter)) }
	get memberships(): api.Memberships { return this.#memberships || (this.#memberships = new api.Memberships(this.#adapter)) }
	get membership_profiles(): api.MembershipProfiles { return this.#membership_profiles || (this.#membership_profiles = new api.MembershipProfiles(this.#adapter)) }
	...
	private localConfig(_config: SdkConfig): void {
		//
	}
...
export type { CommerceLayerConfig, CommerceLayerInitConfig, CommerceLayerProvisioningClient }
